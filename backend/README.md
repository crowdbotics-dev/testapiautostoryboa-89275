...
## Project Structure
    ...
    ├── testapiautostoryboa_89275  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_89275`
...
2. Clone this repo and `cd testapiautostoryboa_89275`
